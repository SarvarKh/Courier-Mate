...
<body>
    <div style="background-image: url('../../assets/img/nyc2.jpeg'); background-attachment: fixed;
        ...
        <div class="container">
            <form action="${pageContext.request.contextPath}/clientsignup" method="post" class="row needs-validation bg-body-secondary rounded p-1" novalidate style="top: 5rem; position: absolute; width: 80%;">
                <div class="col-md-4">
